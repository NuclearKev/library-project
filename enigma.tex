...
we would have privacy, living with someone watching our every move. It it wasn't
for the German's Enigma Machine, we most would have not seen Turing's Bombe
which means we may have not seen computers for a while. Modern day computers and
encryption wouldn't exist without the Enigma's genius. Encryption and
decryption is much more powerful than it was back in World War 2. In order to
remain a ``free'' country, we must fight what the FBI is trying to do just like
Apple is doing. Without our privacy, we are no longer free.
